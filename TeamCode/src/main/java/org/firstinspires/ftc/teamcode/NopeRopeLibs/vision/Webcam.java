...
public class Webcam {
    ...
    private static final int secondsPermissionTimeout = Integer.MAX_VALUE; // fix this!
    ...
    public Webcam(OpMode opmode, boolean LinearOpMode) {
        if (!LinearOpMode)
            this.opMode = opmode;
        else
        ...
        cameraName = opMode.hardwareMap.get(WebcamName.class, "WC");
